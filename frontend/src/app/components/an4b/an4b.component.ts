...
@Component({
  selector: 'app-an4b',
  templateUrl: './an4b.component.html',
  styleUrls: ['./an4b.component.css']
})
export class An4bComponent implements OnInit {
  ...
  an4bStoreSale(): void {
    this.queryService. getan4bStoreSale().subscribe((data: any) => {
        for (const d of data) {
          console.log(d)
